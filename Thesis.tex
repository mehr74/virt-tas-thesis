...
\supervisor  {Antoine Kaufmann}
\advisor     {Antione Kaufmann}
\examiner    {Antione Kaufmann}
\secondexaminer {Anja Feldmann}
\degree      {Master of Science}
\thesiskind  {Master Thesis}
\authors     {Mehrshad Lotfi Foroushani}
\thesistitle {Network Virtualization \\ in a Shared TCP Fast-Path}
\date        {\today}
%\subject     {}
%\keywords    {}
%% ----------------------------------------------------------------
...
\loadchapter{Related}{Related}
\loadchapter{Design}{Design}
\loadchapter{Implementation}{Implementation}
\loadchapter{Evaluation}{Evaluation}
